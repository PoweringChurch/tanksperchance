...
public partial class BaseEnemy : CharacterBody3D
{
    ...
    private Hurtbox charHurtbox;
    private MeshInstance3D bodyMesh;
    //private vars
    public Node3D turret;
    public CharacterBody3D plrchar;
    public Vector3 GoalPosition;
    private Node3D barrelEnd;
    private RayCast3D LosCast;
    public override void _Ready()
    {
        ...
        plrchar = GetNode<CharacterBody3D>("/root/main3d/Player/Character");
